...
面向公开使用的通用 Skill 集合。仓库与网站下载区保持同一份开源 Skill 清单和内容。
...
| `product-design-philosophy` | AI 智能体代理产品设计哲学 |
...
- 用户本人、家人、客户等私人姓名、昵称、联系方式、账户与可识别经历；
- API 密钥、令牌、Cookie、内部 ID 和私人链接；
- 本地路径、服务器地址和环境专属配置；
- 私人投资数据、未授权案例和可识别经历；
- 过时政策断言、绝对化收益承诺和未经确认的外部操作。

公开人物、作者、导演、作品、公司和公开工具名称如与方法有关，可以保留，但必须准确引用，不能伪造其观点或经历。发现私人或凭证信息时，先替换为通用占位或删除，再提交。
